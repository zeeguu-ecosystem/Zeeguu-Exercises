 ...
 **/
	_constructor: function _constructor(data, index, size) {
		this.data = data;
		this.index = index;
 ...
 **/
	checkAnswer: function checkAnswer(chosenWord) {
...
Generator.prototype = {
    ...
    getBookmarks: function getBookmarks() {
        var _this = this;
        _animation2.default.loadingAnimation(true);
        ...
        return _jquery2.default.ajax({
            ...
            data: this.data,
            success: function success(data) {
                _animation2.default.loadingAnimation(false);
            },
            async: true
        });
    },
...
var LoadingAnimation = function () {
    ...
    _createClass(LoadingAnimation, [{
        ...
        value: function createDom() {
            var _this = this;
            _jquery2.default.when(_loader.Loader.loadTemplateIntoElem(_this.animationURL, (0, _jquery2.default)('body'), true)).done(function () {
                _this.updateCache();
            });
        }
        ...
        value: function loadingAnimation(activate) {
            ...
            if (activate === true) {
                (0, _jquery2.default)('body').children('div').addClass('hide');
                (0, _jquery2.default)('#loader').removeClass('hide');
            } else {
                (0, _jquery2.default)('body').children('div').removeClass('hide');
                (0, _jquery2.default)('#loader').addClass('hide');
            }
        }
    }]);
 ...
 **/
	createDom: function createDom() {
		(0, _jquery2.default)("#main-content").html(_loader.Loader.loadTemplate(this.homeTemplateURL));
	},
 ...
 **/
	init: function init() {
		...
		_pubsub2.default.on('generatorCompleted', this.eventFunc);
 ...
 **/
	...
	generateEx: function generateEx() {
		var cardTemplate = _loader.Loader.loadTemplate(this.cardTemplateURL);
 ...
 */
	...
	terminate: function terminate() {
		_pubsub2.default.off('generatorCompleted', this.eventFunc);
	},
